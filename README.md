...
## [hl7v2](./packages/hl7v2/README.md)

HL7 v2 parser, serializer, validator for NodeJS

## [hl7v2-net](./packages/net/README.md)

HL7 v2 server/client for NodeJS

## [hl7v2-dictionary](./packages/dictionary/README.md)

HL7 v2 dictionary for message parsing and serialization
