...
class HL7Client extends EventEmitter {
  ...
  connect(param1, param2, param3) {
    ...
    return new Promise((resolve, reject) => {
      ...
      socket.off('connect', this._connectionListener);
      socket.off('secureConnect', this._connectionListener);
      socket.off('close', this._connectionListener);
      socket.off('error', this._errorListener);
      socket.off('data', this._dataListener);
