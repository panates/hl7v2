const fields = {
  ...
  CNN: {
    desc: 'Composite ID Number And Name (special DT For NDL',
    components: [
      {
        dt: 'ST',
        desc: 'ID Number',
  ...
  MA: {
    ...
    components: [
      ...
      {
        dt: 'NM',
        desc: 'Sample 1 From Channel 4',
        opt: 'R',
        rep: 1
      },
      {
        dt: 'NM',
        desc: 'Sample 1 From Channel 5',
        opt: 'R',
        rep: 1
      },
      {
        dt: 'NM',
        desc: 'Sample 1 From Channel 6',
        opt: 'R',
        rep: 1
      }
    ]
