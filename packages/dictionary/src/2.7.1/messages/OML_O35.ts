...
export const OML_O35: HL7MessageDefinition = {
  desc: 'Laboratory Order - Multiple Order Per Container of Specimen Message',
  segments: {
    MSH: {
      idx: 0,
      min: 1,
      ...
      segments: {
        ...
        SPECIMEN_OBSERVATION: {
          ...
          segments: {
            ...
            PRT: {
              idx: 1,
              desc: 'Participation (for Speciment Observation)',
            },
          },
        },
        SPECIMEN_CONTAINER: {
